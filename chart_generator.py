...
# 匯入 db_manager.py 裡的統計 DataFrame 函式
from db_manager import get_recent_sessions, get_label_summary, get_distraction_summary
...
# ==============================================================
# 1. 【對應截圖：最後總結讀書時間】最近 5 次專注時長趨勢圖 (長條圖)
# ==============================================================
...
# ==============================================================
# 3. 【精準對應截圖：pie chart 紀錄干擾時間比例】(圓餅圖)
# ==============================================================
